...
import com.speakmast.backend.controllers.responses.AuthorityResponse;
...
public class UserController {
    ...
    public ResponseEntity<?> userAuthorities(@RequestParam String email){
        return ResponseEntity.ok( new AuthorityResponse(true, userService.getUserAuthorityBy(email)));
